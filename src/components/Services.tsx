  ...
  return (
    <section id="services" className="bg-cream py-12 md:py-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8">למי זה מתאים</h2>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-right">
          {audiences.map(({ title, text, Icon }) => (
            <div
              key={title}
              className="bg-white rounded-2xl border border-gray-100 p-6 transition-colors duration-200 hover:border-forest/20"
            >
