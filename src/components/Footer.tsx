    ...
    <footer className="bg-forest border-t border-white/10 py-10">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-right">
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm text-cream/70">
          <a href={`tel:${PHONE_TEL}`} className="hover:text-orange-300 transition-colors">
            טלפון: {PHONE_DISPLAY}
          </a>
          <a href="mailto:dr@keshevplus.co.il" className="hover:text-orange-300 transition-colors">
            dr@keshevplus.co.il
          </a>
          <a
