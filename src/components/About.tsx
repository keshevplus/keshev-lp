    ...
    <section id="about" className="bg-white py-20 md:py-28">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-14 items-center">
          ...
          <div className="order-2 bg-cream border border-gray-100 rounded-2xl p-7 sm:p-9 text-right">
            ...
            <a
              href="#contact"
              className="inline-flex items-center gap-2 bg-forest text-white px-6 py-3 rounded-xl font-semibold transition-colors duration-200 hover:bg-forest-light mt-7"
            >
              צור קשר לייעוץ
            </a>
          </div>
